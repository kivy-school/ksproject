...
LAUNCH_SCREEN_STORYBOARD = """<?xml version="1.0" encoding="UTF-8"?>
...
# A minimal `app/main.py` shim: it imports the user's installed module.
APP_MAIN_PY_TEMPLATE = """import {module_name}
