...
```
project_dist/gradle/app/src/main/assets/site_packages/<arch>/
...
- `--extra-index-url` pointing to PySwift and KivySchool channels for pre-built mobile wheels
...
├── lib/
│   └── arm64-v8a/
│       ├── libpython3.13.so       # CPython runtime
...
| Site-packages (Python) | `app/src/main/assets/site_packages/<abi>/` | `assets/` in APK |
